...
/**
 * Provides the local service interface for social_login. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see social_loginLocalServiceUtil
...
public interface social_loginLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link social_loginLocalServiceUtil} to access the social_login local service. Add custom service methods to {@link com.db.service.impl.social_loginLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
