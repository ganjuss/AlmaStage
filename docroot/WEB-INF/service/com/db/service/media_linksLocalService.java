...
/**
 * Provides the local service interface for media_links. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see media_linksLocalServiceUtil
...
public interface media_linksLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link media_linksLocalServiceUtil} to access the media_links local service. Add custom service methods to {@link com.db.service.impl.media_linksLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
