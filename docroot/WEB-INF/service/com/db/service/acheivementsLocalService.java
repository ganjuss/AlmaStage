...
/**
 * Provides the local service interface for acheivements. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see acheivementsLocalServiceUtil
...
public interface acheivementsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link acheivementsLocalServiceUtil} to access the acheivements local service. Add custom service methods to {@link com.db.service.impl.acheivementsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
