...
/**
 * Provides the local service interface for cfm. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see cfmLocalServiceUtil
...
public interface cfmLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link cfmLocalServiceUtil} to access the cfm local service. Add custom service methods to {@link com.db.service.impl.cfmLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
