...
/**
 * Provides the local service interface for about_us. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see about_usLocalServiceUtil
...
public interface about_usLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link about_usLocalServiceUtil} to access the about_us local service. Add custom service methods to {@link com.db.service.impl.about_usLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
