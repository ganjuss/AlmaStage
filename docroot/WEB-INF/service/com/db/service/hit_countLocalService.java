...
/**
 * Provides the local service interface for hit_count. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see hit_countLocalServiceUtil
...
public interface hit_countLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link hit_countLocalServiceUtil} to access the hit_count local service. Add custom service methods to {@link com.db.service.impl.hit_countLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
