...
/**
 * Provides the local service interface for profile_social_link. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see profile_social_linkLocalServiceUtil
...
public interface profile_social_linkLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link profile_social_linkLocalServiceUtil} to access the profile_social_link local service. Add custom service methods to {@link com.db.service.impl.profile_social_linkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
