...
/**
 * The persistence utility for the social_login service. This utility wraps {@link social_loginPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class social_loginUtil {
	 ...
	 */
	public static void clearCache(social_login social_login) {
		getPersistence().clearCache(social_login);
	}
	 ...
	 */
	public static List<social_login> findWithDynamicQuery(
	 ...
	 */
	public static social_login update(social_login social_login)
		throws SystemException {
		return getPersistence().update(social_login);
	}
	...
	public static social_login update(social_login social_login,
		...
		return getPersistence().update(social_login, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.db.model.social_login social_login) {
		getPersistence().cacheResult(social_login);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(social_logins);
	}
	...
	*/
	public static com.db.model.social_login create(long cid) {
	...
	*/
	public static com.db.model.social_login remove(long cid)
		throws com.db.NoSuchsocial_loginException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(cid);
	}

	public static com.db.model.social_login updateImpl(
		com.db.model.social_login social_login)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(social_login);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.db.model.social_login findByPrimaryKey(long cid)
		throws com.db.NoSuchsocial_loginException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.db.model.social_login fetchByPrimaryKey(long cid)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.db.model.social_login> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.db.model.social_login> findAll(int start,
	...
	*/
	...
	public static social_loginPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (social_loginPersistence)PortletBeanLocatorUtil.locate(com.db.service.ClpSerializer.getServletContextName(),
					social_loginPersistence.class.getName());

			ReferenceRegistry.registerReference(social_loginUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(social_loginPersistence persistence) {
	}

	private static social_loginPersistence _persistence;
}