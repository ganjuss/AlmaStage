...
/**
 * The persistence utility for the about_us service. This utility wraps {@link about_usPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class about_usUtil {
	 ...
	 */
	public static void clearCache(about_us about_us) {
		getPersistence().clearCache(about_us);
	}
	 ...
	 */
	public static List<about_us> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<about_us> findWithDynamicQuery(
	 ...
	 */
	public static about_us update(about_us about_us) throws SystemException {
		return getPersistence().update(about_us);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static about_us update(about_us about_us,
		ServiceContext serviceContext) throws SystemException {
		return getPersistence().update(about_us, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.db.model.about_us about_us) {
		getPersistence().cacheResult(about_us);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.db.model.about_us> about_uses) {
		getPersistence().cacheResult(about_uses);
	}
	...
	*/
	public static com.db.model.about_us create(long cid) {
	...
	*/
	public static com.db.model.about_us remove(long cid)
		throws com.db.NoSuchabout_usException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(cid);
	}

	public static com.db.model.about_us updateImpl(
		com.db.model.about_us about_us)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(about_us);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.db.model.about_us findByPrimaryKey(long cid)
		throws com.db.NoSuchabout_usException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.db.model.about_us fetchByPrimaryKey(long cid)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.db.model.about_us> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.db.model.about_us> findAll(int start,
	...
	*/
	...
	public static about_usPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (about_usPersistence)PortletBeanLocatorUtil.locate(com.db.service.ClpSerializer.getServletContextName(),
					about_usPersistence.class.getName());

			ReferenceRegistry.registerReference(about_usUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(about_usPersistence persistence) {
	}

	private static about_usPersistence _persistence;
}