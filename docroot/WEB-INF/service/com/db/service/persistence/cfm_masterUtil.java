...
/**
 * The persistence utility for the cfm_master service. This utility wraps {@link cfm_masterPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class cfm_masterUtil {
	 ...
	 */
	public static void clearCache(cfm_master cfm_master) {
		getPersistence().clearCache(cfm_master);
	}
	 ...
	 */
	public static List<cfm_master> findWithDynamicQuery(
	 ...
	 */
	public static cfm_master update(cfm_master cfm_master)
		throws SystemException {
		return getPersistence().update(cfm_master);
	}
	...
	public static cfm_master update(cfm_master cfm_master,
		...
		return getPersistence().update(cfm_master, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.db.model.cfm_master cfm_master) {
		getPersistence().cacheResult(cfm_master);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.db.model.cfm_master> cfm_masters) {
		getPersistence().cacheResult(cfm_masters);
	}
	...
	*/
	public static com.db.model.cfm_master create(long cid) {
	...
	*/
	public static com.db.model.cfm_master remove(long cid)
		throws com.db.NoSuchcfm_masterException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(cid);
	}

	public static com.db.model.cfm_master updateImpl(
		com.db.model.cfm_master cfm_master)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(cfm_master);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.db.model.cfm_master findByPrimaryKey(long cid)
		throws com.db.NoSuchcfm_masterException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.db.model.cfm_master fetchByPrimaryKey(long cid)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.db.model.cfm_master> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.db.model.cfm_master> findAll(int start,
	...
	*/
	...
	public static cfm_masterPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (cfm_masterPersistence)PortletBeanLocatorUtil.locate(com.db.service.ClpSerializer.getServletContextName(),
					cfm_masterPersistence.class.getName());

			ReferenceRegistry.registerReference(cfm_masterUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(cfm_masterPersistence persistence) {
	}

	private static cfm_masterPersistence _persistence;
}