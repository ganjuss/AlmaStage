...
/**
 * The persistence utility for the acheivements service. This utility wraps {@link acheivementsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class acheivementsUtil {
	 ...
	 */
	public static void clearCache(acheivements acheivements) {
		getPersistence().clearCache(acheivements);
	}
	 ...
	 */
	public static List<acheivements> findWithDynamicQuery(
	 ...
	 */
	public static acheivements update(acheivements acheivements)
		throws SystemException {
		return getPersistence().update(acheivements);
	}
	...
	public static acheivements update(acheivements acheivements,
		...
		return getPersistence().update(acheivements, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.db.model.acheivements acheivements) {
		getPersistence().cacheResult(acheivements);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(acheivementses);
	}
	...
	*/
	public static com.db.model.acheivements create(long cid) {
	...
	*/
	public static com.db.model.acheivements remove(long cid)
		throws com.db.NoSuchacheivementsException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(cid);
	}

	public static com.db.model.acheivements updateImpl(
		com.db.model.acheivements acheivements)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(acheivements);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.db.model.acheivements findByPrimaryKey(long cid)
		throws com.db.NoSuchacheivementsException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.db.model.acheivements fetchByPrimaryKey(long cid)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.db.model.acheivements> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.db.model.acheivements> findAll(int start,
	...
	*/
	...
	public static acheivementsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (acheivementsPersistence)PortletBeanLocatorUtil.locate(com.db.service.ClpSerializer.getServletContextName(),
					acheivementsPersistence.class.getName());

			ReferenceRegistry.registerReference(acheivementsUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(acheivementsPersistence persistence) {
	}

	private static acheivementsPersistence _persistence;
}