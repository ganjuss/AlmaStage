...
/**
 * Provides the local service interface for user_contact. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see user_contactLocalServiceUtil
...
public interface user_contactLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link user_contactLocalServiceUtil} to access the user_contact local service. Add custom service methods to {@link com.db.service.impl.user_contactLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
