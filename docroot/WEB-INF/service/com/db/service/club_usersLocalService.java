...
/**
 * Provides the local service interface for club_users. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see club_usersLocalServiceUtil
...
public interface club_usersLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link club_usersLocalServiceUtil} to access the club_users local service. Add custom service methods to {@link com.db.service.impl.club_usersLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
