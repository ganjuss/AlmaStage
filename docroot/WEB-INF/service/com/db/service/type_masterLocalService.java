...
/**
 * Provides the local service interface for type_master. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see type_masterLocalServiceUtil
...
public interface type_masterLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link type_masterLocalServiceUtil} to access the type_master local service. Add custom service methods to {@link com.db.service.impl.type_masterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
