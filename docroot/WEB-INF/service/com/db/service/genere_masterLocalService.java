...
/**
 * Provides the local service interface for genere_master. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ganjuss
 * @see genere_masterLocalServiceUtil
...
public interface genere_masterLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link genere_masterLocalServiceUtil} to access the genere_master local service. Add custom service methods to {@link com.db.service.impl.genere_masterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
