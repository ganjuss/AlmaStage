...
import com.db.service.media_linksLocalService;
...
/**
 * Provides the base implementation for the media_links local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.media_linksLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class media_linksLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements media_linksLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.media_linksLocalServiceUtil} to access the media_links local service.
	 */
	...
	@Override
	public media_links addmedia_links(media_links media_links)
		throws SystemException {
		media_links.setNew(true);

		return media_linksPersistence.update(media_links);
	}
	 ...
	 */
	@Override
	public media_links createmedia_links(long cid) {
		return media_linksPersistence.create(cid);
	}
	...
	@Override
	public media_links deletemedia_links(long cid)
		throws PortalException, SystemException {
		return media_linksPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public media_links deletemedia_links(media_links media_links)
		throws SystemException {
		return media_linksPersistence.remove(media_links);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(media_links.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return media_linksPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return media_linksPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return media_linksPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public media_links fetchmedia_links(long cid) throws SystemException {
		return media_linksPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public media_links getmedia_links(long cid)
		throws PortalException, SystemException {
		return media_linksPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return media_linksPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<media_links> getmedia_linkses(int start, int end)
		throws SystemException {
		return media_linksPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getmedia_linksesCount() throws SystemException {
		return media_linksPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public media_links updatemedia_links(media_links media_links)
		throws SystemException {
		return media_linksPersistence.update(media_links);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.media_links",
			media_linksLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.media_links");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = media_linksPersistence.getDataSource();
	...
	private media_linksLocalServiceClpInvoker _clpInvoker = new media_linksLocalServiceClpInvoker();
}