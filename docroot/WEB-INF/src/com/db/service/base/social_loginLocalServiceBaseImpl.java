...
import com.db.service.social_loginLocalService;
...
/**
 * Provides the base implementation for the social_login local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.social_loginLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class social_loginLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements social_loginLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.social_loginLocalServiceUtil} to access the social_login local service.
	 */
	...
	@Override
	public social_login addsocial_login(social_login social_login)
		throws SystemException {
		social_login.setNew(true);

		return social_loginPersistence.update(social_login);
	}
	 ...
	 */
	@Override
	public social_login createsocial_login(long cid) {
		return social_loginPersistence.create(cid);
	}
	...
	@Override
	public social_login deletesocial_login(long cid)
		throws PortalException, SystemException {
		return social_loginPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public social_login deletesocial_login(social_login social_login)
		throws SystemException {
		return social_loginPersistence.remove(social_login);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(social_login.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return social_loginPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return social_loginPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public social_login fetchsocial_login(long cid) throws SystemException {
		return social_loginPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public social_login getsocial_login(long cid)
		throws PortalException, SystemException {
		return social_loginPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return social_loginPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<social_login> getsocial_logins(int start, int end)
		throws SystemException {
		return social_loginPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getsocial_loginsCount() throws SystemException {
		return social_loginPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public social_login updatesocial_login(social_login social_login)
		throws SystemException {
		return social_loginPersistence.update(social_login);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.social_login",
			social_loginLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.social_login");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = social_loginPersistence.getDataSource();
	...
	private social_loginLocalServiceClpInvoker _clpInvoker = new social_loginLocalServiceClpInvoker();
}