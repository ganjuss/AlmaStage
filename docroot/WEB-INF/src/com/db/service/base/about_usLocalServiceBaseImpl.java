...
import com.db.service.about_usLocalService;
...
/**
 * Provides the base implementation for the about_us local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.about_usLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class about_usLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements about_usLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.about_usLocalServiceUtil} to access the about_us local service.
	 */
	...
	@Override
	public about_us addabout_us(about_us about_us) throws SystemException {
		about_us.setNew(true);

		return about_usPersistence.update(about_us);
	}
	 ...
	 */
	@Override
	public about_us createabout_us(long cid) {
		return about_usPersistence.create(cid);
	}
	...
	@Override
	public about_us deleteabout_us(long cid)
		throws PortalException, SystemException {
		return about_usPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public about_us deleteabout_us(about_us about_us) throws SystemException {
		return about_usPersistence.remove(about_us);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(about_us.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return about_usPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return about_usPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return about_usPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return about_usPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public about_us fetchabout_us(long cid) throws SystemException {
		return about_usPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public about_us getabout_us(long cid)
		throws PortalException, SystemException {
		return about_usPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return about_usPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<about_us> getabout_uses(int start, int end)
		throws SystemException {
		return about_usPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getabout_usesCount() throws SystemException {
		return about_usPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public about_us updateabout_us(about_us about_us) throws SystemException {
		return about_usPersistence.update(about_us);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.about_us",
			about_usLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.about_us");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = about_usPersistence.getDataSource();
	...
	private about_usLocalServiceClpInvoker _clpInvoker = new about_usLocalServiceClpInvoker();
}