...
import com.db.service.media_links_masterLocalService;
...
/**
 * Provides the base implementation for the media_links_master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.media_links_masterLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 * @see com.db.service.impl.media_links_masterLocalServiceImpl
 * @see com.db.service.media_links_masterLocalServiceUtil
 * @generated
 */
public abstract class media_links_masterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements media_links_masterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.media_links_masterLocalServiceUtil} to access the media_links_master local service.
	 */
	...
	@Override
	public media_links_master addmedia_links_master(
		media_links_master media_links_master) throws SystemException {
		media_links_master.setNew(true);

		return media_links_masterPersistence.update(media_links_master);
	}
	 ...
	 */
	@Override
	public media_links_master createmedia_links_master(long cid) {
		return media_links_masterPersistence.create(cid);
	}
	...
	@Override
	public media_links_master deletemedia_links_master(long cid)
		throws PortalException, SystemException {
		return media_links_masterPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public media_links_master deletemedia_links_master(
		media_links_master media_links_master) throws SystemException {
		return media_links_masterPersistence.remove(media_links_master);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(media_links_master.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return media_links_masterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return media_links_masterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public media_links_master fetchmedia_links_master(long cid)
		throws SystemException {
		return media_links_masterPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public media_links_master getmedia_links_master(long cid)
		throws PortalException, SystemException {
		return media_links_masterPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return media_links_masterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<media_links_master> getmedia_links_masters(int start, int end)
		throws SystemException {
		return media_links_masterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getmedia_links_mastersCount() throws SystemException {
		return media_links_masterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public media_links_master updatemedia_links_master(
		media_links_master media_links_master) throws SystemException {
		return media_links_masterPersistence.update(media_links_master);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.media_links_master",
			media_links_masterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.media_links_master");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = media_links_masterPersistence.getDataSource();
	...
	private media_links_masterLocalServiceClpInvoker _clpInvoker = new media_links_masterLocalServiceClpInvoker();
}