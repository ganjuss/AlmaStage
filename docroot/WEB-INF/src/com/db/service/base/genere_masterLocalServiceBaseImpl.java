...
import com.db.service.genere_masterLocalService;
...
/**
 * Provides the base implementation for the genere_master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.genere_masterLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class genere_masterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements genere_masterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.genere_masterLocalServiceUtil} to access the genere_master local service.
	 */
	...
	@Override
	public genere_master addgenere_master(genere_master genere_master)
		throws SystemException {
		genere_master.setNew(true);

		return genere_masterPersistence.update(genere_master);
	}
	 ...
	 */
	@Override
	public genere_master creategenere_master(long cid) {
		return genere_masterPersistence.create(cid);
	}
	...
	@Override
	public genere_master deletegenere_master(long cid)
		throws PortalException, SystemException {
		return genere_masterPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public genere_master deletegenere_master(genere_master genere_master)
		throws SystemException {
		return genere_masterPersistence.remove(genere_master);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(genere_master.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return genere_masterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return genere_masterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public genere_master fetchgenere_master(long cid) throws SystemException {
		return genere_masterPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public genere_master getgenere_master(long cid)
		throws PortalException, SystemException {
		return genere_masterPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return genere_masterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<genere_master> getgenere_masters(int start, int end)
		throws SystemException {
		return genere_masterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getgenere_mastersCount() throws SystemException {
		return genere_masterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public genere_master updategenere_master(genere_master genere_master)
		throws SystemException {
		return genere_masterPersistence.update(genere_master);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.genere_master",
			genere_masterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.genere_master");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = genere_masterPersistence.getDataSource();
	...
	private genere_masterLocalServiceClpInvoker _clpInvoker = new genere_masterLocalServiceClpInvoker();
}