...
import com.db.service.skill_user_mappingLocalService;
...
/**
 * Provides the base implementation for the skill_user_mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.skill_user_mappingLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 * @see com.db.service.impl.skill_user_mappingLocalServiceImpl
 * @see com.db.service.skill_user_mappingLocalServiceUtil
 * @generated
 */
public abstract class skill_user_mappingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements skill_user_mappingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.skill_user_mappingLocalServiceUtil} to access the skill_user_mapping local service.
	 */
	...
	@Override
	public skill_user_mapping addskill_user_mapping(
		skill_user_mapping skill_user_mapping) throws SystemException {
		skill_user_mapping.setNew(true);

		return skill_user_mappingPersistence.update(skill_user_mapping);
	}
	 ...
	 */
	@Override
	public skill_user_mapping createskill_user_mapping(long cid) {
		return skill_user_mappingPersistence.create(cid);
	}
	...
	@Override
	public skill_user_mapping deleteskill_user_mapping(long cid)
		throws PortalException, SystemException {
		return skill_user_mappingPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public skill_user_mapping deleteskill_user_mapping(
		skill_user_mapping skill_user_mapping) throws SystemException {
		return skill_user_mappingPersistence.remove(skill_user_mapping);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(skill_user_mapping.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return skill_user_mappingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return skill_user_mappingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public skill_user_mapping fetchskill_user_mapping(long cid)
		throws SystemException {
		return skill_user_mappingPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public skill_user_mapping getskill_user_mapping(long cid)
		throws PortalException, SystemException {
		return skill_user_mappingPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return skill_user_mappingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<skill_user_mapping> getskill_user_mappings(int start, int end)
		throws SystemException {
		return skill_user_mappingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getskill_user_mappingsCount() throws SystemException {
		return skill_user_mappingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public skill_user_mapping updateskill_user_mapping(
		skill_user_mapping skill_user_mapping) throws SystemException {
		return skill_user_mappingPersistence.update(skill_user_mapping);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.skill_user_mapping",
			skill_user_mappingLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.skill_user_mapping");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = skill_user_mappingPersistence.getDataSource();
	...
	private skill_user_mappingLocalServiceClpInvoker _clpInvoker = new skill_user_mappingLocalServiceClpInvoker();
}