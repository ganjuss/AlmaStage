...
import com.db.service.club_usersLocalService;
...
/**
 * Provides the base implementation for the club_users local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.club_usersLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class club_usersLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements club_usersLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.club_usersLocalServiceUtil} to access the club_users local service.
	 */
	...
	@Override
	public club_users addclub_users(club_users club_users)
		throws SystemException {
		club_users.setNew(true);

		return club_usersPersistence.update(club_users);
	}
	 ...
	 */
	@Override
	public club_users createclub_users(long cid) {
		return club_usersPersistence.create(cid);
	}
	...
	@Override
	public club_users deleteclub_users(long cid)
		throws PortalException, SystemException {
		return club_usersPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public club_users deleteclub_users(club_users club_users)
		throws SystemException {
		return club_usersPersistence.remove(club_users);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(club_users.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return club_usersPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return club_usersPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return club_usersPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public club_users fetchclub_users(long cid) throws SystemException {
		return club_usersPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public club_users getclub_users(long cid)
		throws PortalException, SystemException {
		return club_usersPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return club_usersPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<club_users> getclub_userses(int start, int end)
		throws SystemException {
		return club_usersPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getclub_usersesCount() throws SystemException {
		return club_usersPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public club_users updateclub_users(club_users club_users)
		throws SystemException {
		return club_usersPersistence.update(club_users);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.club_users",
			club_usersLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.club_users");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = club_usersPersistence.getDataSource();
	...
	private club_usersLocalServiceClpInvoker _clpInvoker = new club_usersLocalServiceClpInvoker();
}