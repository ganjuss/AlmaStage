...
import com.db.service.user_contactLocalService;
...
/**
 * Provides the base implementation for the user_contact local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.user_contactLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class user_contactLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements user_contactLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.user_contactLocalServiceUtil} to access the user_contact local service.
	 */
	...
	@Override
	public user_contact adduser_contact(user_contact user_contact)
		throws SystemException {
		user_contact.setNew(true);

		return user_contactPersistence.update(user_contact);
	}
	 ...
	 */
	@Override
	public user_contact createuser_contact(long cid) {
		return user_contactPersistence.create(cid);
	}
	...
	@Override
	public user_contact deleteuser_contact(long cid)
		throws PortalException, SystemException {
		return user_contactPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public user_contact deleteuser_contact(user_contact user_contact)
		throws SystemException {
		return user_contactPersistence.remove(user_contact);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(user_contact.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return user_contactPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return user_contactPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public user_contact fetchuser_contact(long cid) throws SystemException {
		return user_contactPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public user_contact getuser_contact(long cid)
		throws PortalException, SystemException {
		return user_contactPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return user_contactPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<user_contact> getuser_contacts(int start, int end)
		throws SystemException {
		return user_contactPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getuser_contactsCount() throws SystemException {
		return user_contactPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public user_contact updateuser_contact(user_contact user_contact)
		throws SystemException {
		return user_contactPersistence.update(user_contact);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.user_contact",
			user_contactLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.user_contact");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = user_contactPersistence.getDataSource();
	...
	private user_contactLocalServiceClpInvoker _clpInvoker = new user_contactLocalServiceClpInvoker();
}