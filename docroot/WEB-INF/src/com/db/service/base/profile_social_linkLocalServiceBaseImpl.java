...
import com.db.service.profile_social_linkLocalService;
...
/**
 * Provides the base implementation for the profile_social_link local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.profile_social_linkLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class profile_social_linkLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements profile_social_linkLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.profile_social_linkLocalServiceUtil} to access the profile_social_link local service.
	 */
	...
	@Override
	public profile_social_link addprofile_social_link(
		profile_social_link profile_social_link) throws SystemException {
		profile_social_link.setNew(true);

		return profile_social_linkPersistence.update(profile_social_link);
	}
	 ...
	 */
	@Override
	public profile_social_link createprofile_social_link(long cid) {
		return profile_social_linkPersistence.create(cid);
	}
	...
	@Override
	public profile_social_link deleteprofile_social_link(long cid)
		throws PortalException, SystemException {
		return profile_social_linkPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public profile_social_link deleteprofile_social_link(
		profile_social_link profile_social_link) throws SystemException {
		return profile_social_linkPersistence.remove(profile_social_link);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(profile_social_link.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return profile_social_linkPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return profile_social_linkPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public profile_social_link fetchprofile_social_link(long cid)
		throws SystemException {
		return profile_social_linkPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public profile_social_link getprofile_social_link(long cid)
		throws PortalException, SystemException {
		return profile_social_linkPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return profile_social_linkPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<profile_social_link> getprofile_social_links(int start, int end)
		throws SystemException {
		return profile_social_linkPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getprofile_social_linksCount() throws SystemException {
		return profile_social_linkPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public profile_social_link updateprofile_social_link(
		profile_social_link profile_social_link) throws SystemException {
		return profile_social_linkPersistence.update(profile_social_link);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.profile_social_link",
			profile_social_linkLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = profile_social_linkPersistence.getDataSource();
	...
	private profile_social_linkLocalServiceClpInvoker _clpInvoker = new profile_social_linkLocalServiceClpInvoker();
}