...
import com.db.service.clubsLocalService;
...
/**
 * Provides the base implementation for the clubs local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.clubsLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class clubsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements clubsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.clubsLocalServiceUtil} to access the clubs local service.
	 */
	...
	@Override
	public clubs addclubs(clubs clubs) throws SystemException {
		clubs.setNew(true);

		return clubsPersistence.update(clubs);
	}
	 ...
	 */
	@Override
	public clubs createclubs(long cid) {
		return clubsPersistence.create(cid);
	}
	...
	@Override
	public clubs deleteclubs(long cid) throws PortalException, SystemException {
		return clubsPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public clubs deleteclubs(clubs clubs) throws SystemException {
		return clubsPersistence.remove(clubs);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(clubs.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return clubsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return clubsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return clubsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return clubsPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public clubs fetchclubs(long cid) throws SystemException {
		return clubsPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public clubs getclubs(long cid) throws PortalException, SystemException {
		return clubsPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return clubsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<clubs> getclubses(int start, int end) throws SystemException {
		return clubsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getclubsesCount() throws SystemException {
		return clubsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public clubs updateclubs(clubs clubs) throws SystemException {
		return clubsPersistence.update(clubs);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.clubs",
			clubsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister("com.db.model.clubs");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = clubsPersistence.getDataSource();
	...
	private clubsLocalServiceClpInvoker _clpInvoker = new clubsLocalServiceClpInvoker();
}