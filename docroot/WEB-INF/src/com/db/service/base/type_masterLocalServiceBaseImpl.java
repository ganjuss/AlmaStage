...
import com.db.service.type_masterLocalService;
...
/**
 * Provides the base implementation for the type_master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.type_masterLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class type_masterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements type_masterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.type_masterLocalServiceUtil} to access the type_master local service.
	 */
	...
	@Override
	public type_master addtype_master(type_master type_master)
		throws SystemException {
		type_master.setNew(true);

		return type_masterPersistence.update(type_master);
	}
	 ...
	 */
	@Override
	public type_master createtype_master(long cid) {
		return type_masterPersistence.create(cid);
	}
	...
	@Override
	public type_master deletetype_master(long cid)
		throws PortalException, SystemException {
		return type_masterPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public type_master deletetype_master(type_master type_master)
		throws SystemException {
		return type_masterPersistence.remove(type_master);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(type_master.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return type_masterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return type_masterPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return type_masterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public type_master fetchtype_master(long cid) throws SystemException {
		return type_masterPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public type_master gettype_master(long cid)
		throws PortalException, SystemException {
		return type_masterPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return type_masterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<type_master> gettype_masters(int start, int end)
		throws SystemException {
		return type_masterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int gettype_mastersCount() throws SystemException {
		return type_masterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public type_master updatetype_master(type_master type_master)
		throws SystemException {
		return type_masterPersistence.update(type_master);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.type_master",
			type_masterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.type_master");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = type_masterPersistence.getDataSource();
	...
	private type_masterLocalServiceClpInvoker _clpInvoker = new type_masterLocalServiceClpInvoker();
}