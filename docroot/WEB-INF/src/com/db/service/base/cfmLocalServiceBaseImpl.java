...
import com.db.service.cfmLocalService;
...
/**
 * Provides the base implementation for the cfm local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.cfmLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class cfmLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements cfmLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.cfmLocalServiceUtil} to access the cfm local service.
	 */
	...
	@Override
	public cfm addcfm(cfm cfm) throws SystemException {
		cfm.setNew(true);

		return cfmPersistence.update(cfm);
	}
	 ...
	 */
	@Override
	public cfm createcfm(long cid) {
		return cfmPersistence.create(cid);
	}
	...
	@Override
	public cfm deletecfm(long cid) throws PortalException, SystemException {
		return cfmPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public cfm deletecfm(cfm cfm) throws SystemException {
		return cfmPersistence.remove(cfm);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(cfm.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return cfmPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return cfmPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cfmPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return cfmPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public cfm fetchcfm(long cid) throws SystemException {
		return cfmPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public cfm getcfm(long cid) throws PortalException, SystemException {
		return cfmPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cfmPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<cfm> getcfms(int start, int end) throws SystemException {
		return cfmPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getcfmsCount() throws SystemException {
		return cfmPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public cfm updatecfm(cfm cfm) throws SystemException {
		return cfmPersistence.update(cfm);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.cfm",
			cfmLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister("com.db.model.cfm");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cfmPersistence.getDataSource();
	...
	private cfmLocalServiceClpInvoker _clpInvoker = new cfmLocalServiceClpInvoker();
}