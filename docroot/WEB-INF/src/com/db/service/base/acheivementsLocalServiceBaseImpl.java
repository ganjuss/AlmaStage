...
import com.db.service.acheivementsLocalService;
...
/**
 * Provides the base implementation for the acheivements local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.acheivementsLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class acheivementsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements acheivementsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.acheivementsLocalServiceUtil} to access the acheivements local service.
	 */
	...
	@Override
	public acheivements addacheivements(acheivements acheivements)
		throws SystemException {
		acheivements.setNew(true);

		return acheivementsPersistence.update(acheivements);
	}
	 ...
	 */
	@Override
	public acheivements createacheivements(long cid) {
		return acheivementsPersistence.create(cid);
	}
	...
	@Override
	public acheivements deleteacheivements(long cid)
		throws PortalException, SystemException {
		return acheivementsPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public acheivements deleteacheivements(acheivements acheivements)
		throws SystemException {
		return acheivementsPersistence.remove(acheivements);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(acheivements.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return acheivementsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return acheivementsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public acheivements fetchacheivements(long cid) throws SystemException {
		return acheivementsPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public acheivements getacheivements(long cid)
		throws PortalException, SystemException {
		return acheivementsPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return acheivementsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<acheivements> getacheivementses(int start, int end)
		throws SystemException {
		return acheivementsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getacheivementsesCount() throws SystemException {
		return acheivementsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public acheivements updateacheivements(acheivements acheivements)
		throws SystemException {
		return acheivementsPersistence.update(acheivements);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.acheivements",
			acheivementsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.acheivements");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = acheivementsPersistence.getDataSource();
	...
	private acheivementsLocalServiceClpInvoker _clpInvoker = new acheivementsLocalServiceClpInvoker();
}