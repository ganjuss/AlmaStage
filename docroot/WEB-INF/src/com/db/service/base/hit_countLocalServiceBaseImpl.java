...
import com.db.service.hit_countLocalService;
...
/**
 * Provides the base implementation for the hit_count local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.hit_countLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class hit_countLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements hit_countLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.hit_countLocalServiceUtil} to access the hit_count local service.
	 */
	...
	@Override
	public hit_count addhit_count(hit_count hit_count)
		throws SystemException {
		hit_count.setNew(true);

		return hit_countPersistence.update(hit_count);
	}
	 ...
	 */
	@Override
	public hit_count createhit_count(long cid) {
		return hit_countPersistence.create(cid);
	}
	...
	@Override
	public hit_count deletehit_count(long cid)
		throws PortalException, SystemException {
		return hit_countPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public hit_count deletehit_count(hit_count hit_count)
		throws SystemException {
		return hit_countPersistence.remove(hit_count);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(hit_count.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return hit_countPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return hit_countPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return hit_countPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public hit_count fetchhit_count(long cid) throws SystemException {
		return hit_countPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public hit_count gethit_count(long cid)
		throws PortalException, SystemException {
		return hit_countPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return hit_countPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<hit_count> gethit_counts(int start, int end)
		throws SystemException {
		return hit_countPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int gethit_countsCount() throws SystemException {
		return hit_countPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public hit_count updatehit_count(hit_count hit_count)
		throws SystemException {
		return hit_countPersistence.update(hit_count);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.hit_count",
			hit_countLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.hit_count");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = hit_countPersistence.getDataSource();
	...
	private hit_countLocalServiceClpInvoker _clpInvoker = new hit_countLocalServiceClpInvoker();
}