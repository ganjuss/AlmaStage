...
import com.db.service.social_type_masterLocalService;
...
/**
 * Provides the base implementation for the social_type_master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.social_type_masterLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class social_type_masterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements social_type_masterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.social_type_masterLocalServiceUtil} to access the social_type_master local service.
	 */
	...
	@Override
	public social_type_master addsocial_type_master(
		social_type_master social_type_master) throws SystemException {
		social_type_master.setNew(true);

		return social_type_masterPersistence.update(social_type_master);
	}
	 ...
	 */
	@Override
	public social_type_master createsocial_type_master(long cid) {
		return social_type_masterPersistence.create(cid);
	}
	...
	@Override
	public social_type_master deletesocial_type_master(long cid)
		throws PortalException, SystemException {
		return social_type_masterPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public social_type_master deletesocial_type_master(
		social_type_master social_type_master) throws SystemException {
		return social_type_masterPersistence.remove(social_type_master);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(social_type_master.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return social_type_masterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return social_type_masterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public social_type_master fetchsocial_type_master(long cid)
		throws SystemException {
		return social_type_masterPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public social_type_master getsocial_type_master(long cid)
		throws PortalException, SystemException {
		return social_type_masterPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return social_type_masterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<social_type_master> getsocial_type_masters(int start, int end)
		throws SystemException {
		return social_type_masterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getsocial_type_mastersCount() throws SystemException {
		return social_type_masterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public social_type_master updatesocial_type_master(
		social_type_master social_type_master) throws SystemException {
		return social_type_masterPersistence.update(social_type_master);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.social_type_master",
			social_type_masterLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.social_type_master");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = social_type_masterPersistence.getDataSource();
	...
	private social_type_masterLocalServiceClpInvoker _clpInvoker = new social_type_masterLocalServiceClpInvoker();
}