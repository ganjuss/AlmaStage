...
import com.db.service.skillLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.skillLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 * @see com.db.service.impl.skillLocalServiceImpl
 * @see com.db.service.skillLocalServiceUtil
 * @generated
 */
public abstract class skillLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.skillLocalServiceUtil} to access the skill local service.
	 */
	 ...
	 */
	@Override
	public skill createskill(long cid) {
		return skillPersistence.create(cid);
	}
	...
	@Override
	public skill deleteskill(long cid) throws PortalException, SystemException {
		return skillPersistence.remove(cid);
	}
	...
	@Override
	public skill fetchskill(long cid) throws SystemException {
		return skillPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public skill getskill(long cid) throws PortalException, SystemException {
		return skillPersistence.findByPrimaryKey(cid);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.skill",
			skillLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister("com.db.model.skill");
	}
