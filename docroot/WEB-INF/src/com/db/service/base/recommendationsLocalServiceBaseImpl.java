...
import com.db.service.recommendationsLocalService;
...
/**
 * Provides the base implementation for the recommendations local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.db.service.impl.recommendationsLocalServiceImpl}.
 * </p>
 *
 * @author ganjuss
 ...
 * @generated
 */
public abstract class recommendationsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements recommendationsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.db.service.recommendationsLocalServiceUtil} to access the recommendations local service.
	 */
	...
	public recommendations addrecommendations(recommendations recommendations)
		...
		return recommendationsPersistence.update(recommendations);
	}
	 ...
	 */
	@Override
	public recommendations createrecommendations(long cid) {
		return recommendationsPersistence.create(cid);
	}
	...
	@Override
	public recommendations deleterecommendations(long cid)
		throws PortalException, SystemException {
		return recommendationsPersistence.remove(cid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public recommendations deleterecommendations(
		recommendations recommendations) throws SystemException {
		return recommendationsPersistence.remove(recommendations);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(recommendations.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return recommendationsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return recommendationsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public recommendations fetchrecommendations(long cid)
		throws SystemException {
		return recommendationsPersistence.fetchByPrimaryKey(cid);
	}
	 ...
	 */
	@Override
	public recommendations getrecommendations(long cid)
		throws PortalException, SystemException {
		return recommendationsPersistence.findByPrimaryKey(cid);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return recommendationsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<recommendations> getrecommendationses(int start, int end)
		throws SystemException {
		return recommendationsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getrecommendationsesCount() throws SystemException {
		return recommendationsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public recommendations updaterecommendations(
		recommendations recommendations) throws SystemException {
		return recommendationsPersistence.update(recommendations);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.db.model.recommendations",
			recommendationsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.db.model.recommendations");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = recommendationsPersistence.getDataSource();
	...
	private recommendationsLocalServiceClpInvoker _clpInvoker = new recommendationsLocalServiceClpInvoker();
}