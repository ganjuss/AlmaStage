...
import com.db.NoSuchrecommendationsException;

import com.db.model.impl.recommendationsImpl;
import com.db.model.impl.recommendationsModelImpl;
...
public class recommendationsPersistenceImpl extends BasePersistenceImpl<recommendations>
	 ...
	 */
	@Override
	public recommendations remove(long cid)
	...
	public recommendations updateImpl(
		com.db.model.recommendations recommendations) throws SystemException {
		recommendations = toUnwrappedModel(recommendations);
	...
	protected recommendations toUnwrappedModel(recommendations recommendations) {
		...
		recommendationsImpl.setCid(recommendations.getCid());
	 ...
	 */
	@Override
	public recommendations findByPrimaryKey(long cid)
		throws NoSuchrecommendationsException, SystemException {
	 ...
	 */
	@Override
	public recommendations fetchByPrimaryKey(long cid)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.db.model.recommendations")));
